...
const makeStyles = (theme: Theme) =>
  StyleSheet.create({
    ...
    barValue: { width: 56, textAlign: 'right', fontFamily: Font.display, fontSize: 12.5, color: theme.text },
    ...
    formulaVar: { fontFamily: Font.displayBold, fontSize: 12.5, color: theme.accent },
